...
import com.example.FTPlogin.UploadFileChooserAdapter.FileInfo;
...
public class logintableActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    //开始
    private static String TAG = logintableActivity.class.getName();
